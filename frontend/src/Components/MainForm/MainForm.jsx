    ...
    <>
      ...
      <section className={styles.first_section}>
        ...
        <div className={styles.btn_container}>
          <button
            className={
              isClicked ? styles.happy_clicked : styles.button_unclicked
            }
            value={"Happy"}
            onClick={handleClick}
          >
          ...
          <button
            className={isClicked ? styles.sad_clicked : styles.button_unclicked}
            value={"Sad"}
            onClick={handleClick}
          >
            <svg
          ...
          <button
            className={
              isClicked ? styles.angry_clicked : styles.button_unclicked
            }
            value={"Angry"}
            onClick={handleClick}
          >
          ...
          <button
            className={
              isClicked ? styles.disgust_clicked : styles.button_unclicked
            }
            value={"Disgust"}
            onClick={handleClick}
          >
          ...
          <button
            className={
              isClicked ? styles.surprised_clicked : styles.button_unclicked
            }
            value={"Surprised"}
            onClick={handleClick}
          >
            <img
              className={styles.surprisedIcon}
              src="/Icons/smiley-surprised.svg"
              alt="Surprised Smiley Icon"
            />
            Surprised
          </button>
          ...
          <button
            className={
              isClicked ? styles.overwhelmed_clicked : styles.button_unclicked
            }
            value={"Overwhelmed"}
            onClick={handleClick}
          >
          ...
          <button
            className={
              isClicked ? styles.anxious_clicked : styles.button_unclicked
            }
            value={"Anxious"}
            onClick={handleClick}
          >
            <img
              className={styles.anxiousIcon}
              src="/Icons/smiley-anxious.svg"
              alt="Anxious Smiley Icon"
            />
            Anxious
          </button>
        </div>
          ...
          <div className={styles.container_inputs}>
            ...
            <div>
              ...
              <input
                ...
                type="file"
                onChange={(e) => setPictureOfTheDay(e.target.value)}
              />
            </div>
          </div>
