...
import { DarkModeOutlined, Brightness5 } from '@mui/icons-material';
      ...
      <ThemeProvider>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.button_container}>
            ...
            <IconButton onClick={handleClick} color="inherit" aria-label="Toggle dark mode">
              {mode === "dark" ? <DarkModeOutlined /> : <Brightness5 />}
