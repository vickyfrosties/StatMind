    ...
    <>
      <section className={styles.first_section}>
        <div className={styles.infos}>
          ...
          {currentEmotion ? (
            <img
              className={styles.current_emotion}
              src={emotionsIcons[currentEmotion.emotions]}
              alt={currentEmotion.emotions}
            />
          ) : (
            <img
              src={defaultIcon}
              alt="There's no feeling saved yet, to start the journey, please enter today's mood."
            />
          )}
        </div>
